@extends('front.main')
@section('title',"Catrgory Page")
@section('main_section')
<main class="main">
    @section('coll_active',"active")
    @if (count($category_products) > 0)
        <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                <a href="index.html" rel="nofollow">Home</a>
                <span></span> Categories <span></span> {{$category_products[0]->category_name}}
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="shop-product-fillter">
                        <div class="totall-product">
                            <p> We found <strong class="text-brand">{{count($category_products)}}</strong> items for you!</p>
                        </div>
                        ...
                        <div class="product-cart-wrap mb-30">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="/product_details/{{$item->slug}}">
                                        ...
                                        @if (isset($hover_category_products_img[$item->p_id]))
                                        <img class="hover-img" src="{{asset('storage/images/')."/".$hover_category_products_img[$item->p_id]}}" alt="">
                                    @endif
                                    </a>
                                </div>
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-price">
                                    <span>Rs.{{$category_products_attr[$item->p_id][0]->price}}</span>
                                    <span class="old-price">Rs.{{$category_products_attr[$item->p_id][0]->mrp}}</span>
                                </div>
                                <div class="product-action-1 show">
                                    <a aria-label="Add To Cart" class="action-btn hover-up" onclick="home_add_to_cart(<?php echo $item->p_id ?>,<?php echo $category_products_attr[$item->p_id][0]->size_id ?>,<?php echo $category_products_attr[$item->p_id][0]->color_id ?>,1)" href="javascript:void(0)"><i class="fi-rs-shopping-bag-add"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 primary-sidebar sticky-sidebar">
                    ...
                    <div class="widget-category mb-30">
                        <h5 class="section-title style-1 mb-30 wow fadeIn animated">Related Sub Categories</h5>
                        <ul class="categories">

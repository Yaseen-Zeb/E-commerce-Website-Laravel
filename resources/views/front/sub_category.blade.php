@extends('front.main')
@section('title',"Sub Catrgory Page")
    ...
    @if (count($sub_category_products) > 0)
        ...
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> Sub Categories <span></span> <a href="">{{$sub_category_products[0]->category_name}}</a> <span></span> <a href="">{{$sub_category_products[0]->sub_cat_name}}</a>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 primary-sidebar sticky-sidebar">
                    ...
                    <div class="widget-category mb-30">
                        <h5 class="section-title style-1 mb-30 wow fadeIn animated">Related Brands</h5>
                         <ul class="categories">
                        @if (count($related_brands) > 0)
                            @foreach ($related_brands as $item)
                                <li><a href="/brand/{{$item->id}}">{{$item->brand_name}}</a></li>
                            @endforeach
                        @else
